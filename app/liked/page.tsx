...
import { HeartIcon, Search, Play, Clock } from "lucide-react";
...
export default function LikedPage() {
  ...
  // Use recently played tracks as mock "liked" tracks
  const likedTracks = recentlyPlayed.tracks;
  ...
  return (
    <div className="px-6 py-6 md:px-8 lg:px-10 pb-32 space-y-6">
      <div className="flex flex-col md:flex-row md:items-end gap-6 mb-8">
        <div className="flex-shrink-0 h-52 w-52 bg-gradient-to-br from-rose-500 to-purple-500 rounded-md flex items-center justify-center">
      ...
      <div className="space-y-1">
        {filteredTracks.length > 0 ? (
          ...
          <div className="py-8 text-center">
            <p className="text-muted-foreground">No liked songs found matching "{searchQuery}"</p>
          </div>
        )}
      </div>
    </div>
